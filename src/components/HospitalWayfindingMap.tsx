...
export const HospitalWayfindingMap: React.FC<HospitalWayfindingMapProps> = ({
  ...
  const handleVoicePlay = () => {
    const text = `현재 위치 1층 키오스크에서 오른쪽 중앙 엘리베이터를 타시고, ${floor}에서 내리세요. 바닥의 ${lineColorName}을 따라오시면 ${room} ${chair}에 도착합니다. 약 ${estimatedMinutes}분, ${walkSteps}보 거리입니다.`;
    speakText(text);
  };
    ...
    >
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-slate-500 text-xs sm:text-sm font-medium mt-0.5">
              현재 위치(1층 키오스크)에서 목적지({floor} {room})까지의 최적 도보 동선입니다.
            </p>
          </div>
        </div>
      ...
      <div className="relative w-full bg-slate-950 rounded-2xl overflow-hidden border-2 border-slate-800 shadow-inner">
        ...
        >
          ...
          {/* ========================================================================= */}
          {/* TAB 2: 1F LOBBY FLOOR (1층 키오스크 ➔ 엘리베이터 승강홀) */}
          {/* ========================================================================= */}
          {activeTab === 'lobbyFloor' && (
            <g id="lobby-floor-group">
              ...
              {/* Start Pin: KIOSK (Present Location) */}
