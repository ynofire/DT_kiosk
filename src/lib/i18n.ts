...
export const I18N_DATA: Record<Language, TranslationStrings> = {
  ...
  en: {
    ...
    hospitalSubtitle: 'Smart Dental Triage Kiosk',
    ...
    staffCallDesc: 'If you have difficulty using the kiosk or need physical assistance, a staff member will assist you immediately.',
